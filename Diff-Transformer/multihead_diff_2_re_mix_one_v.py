...
class MultiheadFlashDiff2(nn.Module):
    ...
    def __init__(
        ...
        self.subln = RMSNorm(self.num_heads * self.head_dim, eps=1e-5, elementwise_affine=True)  # 1.0
    ...
    def forward(
        ...
        attn1, attn_scores11 = self.RPE_selfattention(q1, k1, v, embedding) 
        # attn12, attn_scores12 = self.RPE_selfattention(q1, k1, v, embedding)
        ...
        # attn21, attn_scores21 = self.RPE_selfattention(q2, k2, v, embedding)
        attn2, attn_scores22 = self.RPE_selfattention(q2, k2, v, embedding)
