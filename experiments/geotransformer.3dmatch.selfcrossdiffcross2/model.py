...
class GeoTransformer(nn.Module):
    def __init__(self, cfg):
        ...
        self.transformer = GeometricTransformer(
            cfg.geotransformer.embed_dim,
            cfg.geotransformer.depth,
    ...
    def forward(self, data_dict):
        ...
        output_dict['ref_points_c_y'] = ref_points_c  # 新增，用于提取未处理过的点云超点
        output_dict['src_points_c_y'] = src_points_c
        ...
        #print(f'[Debug] ref_points_c shape: {ref_points_c.shape}')
        #print(f'[Debug] ref_node_knn_points shape: {ref_node_knn_points.shape}')
        output_dict['ref_node_knn_points'] = ref_node_knn_points # 新增，用于提取超点对应的周围点
        ...
        #print(f'[Debug] attention_scores shape: {attention_score.shape}')
        ref_feats_c_norm = F.normalize(ref_feats_c.squeeze(0), p=2, dim=1)
        src_feats_c_norm = F.normalize(src_feats_c.squeeze(0), p=2, dim=1)

        output_dict['ref_feats_c'] = ref_feats_c_norm
        output_dict['src_feats_c'] = src_feats_c_norm
        output_dict['attention_scores'] = attention_scores #新增
