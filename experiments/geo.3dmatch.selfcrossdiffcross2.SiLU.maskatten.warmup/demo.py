...
def main():
    ...
    # 保存配准前
    o3d.io.write_point_cloud("before_registration_ref.ply", ref_pcd)
    o3d.io.write_point_cloud("before_registration_src.ply", src_pcd)

    # 应用变换
    src_pcd.transform(estimated_transform)

    # 保存配准后
    o3d.io.write_point_cloud("after_registration_ref.ply", ref_pcd)
    o3d.io.write_point_cloud("after_registration_src.ply", src_pcd)
