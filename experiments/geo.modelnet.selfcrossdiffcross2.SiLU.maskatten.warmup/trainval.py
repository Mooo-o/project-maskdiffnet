...
class Trainer(IterBasedTrainer):
    def __init__(self, cfg):
        ...
        scheduler = OneCycleLR(
            ...
            pct_start=cfg.optim.warmup_steps / cfg.optim.max_iteration,  # warmup 比例（如 10000 / 400000）
            anneal_strategy='cos',
            div_factor=10,  # 新增，让 initial_lr = 2e-5
            final_div_factor=2e-4 / 1e-5,  # = 50，用于从 5e-4 衰减到 1e-5
        )
