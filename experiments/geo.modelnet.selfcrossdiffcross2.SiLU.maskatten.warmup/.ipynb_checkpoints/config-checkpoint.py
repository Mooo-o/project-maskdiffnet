...
_C.test.class_indices = "unseen" # seen unseen
...
_C.geotransformer.hidden_dim = 256 # 原256
_C.geotransformer.output_dim = 256
_C.geotransformer.num_heads = 4
_C.geotransformer.blocks = ["self", "cross", "diff", "cross", "self", "cross", "diff", "cross"]
